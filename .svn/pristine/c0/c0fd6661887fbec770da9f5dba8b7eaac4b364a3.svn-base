                        ...
                        <ul id="accordionExample">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="password" name="password" placeholder="modify password">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Grade</label>
                                                    <div class="form-input form">
                                                    	<c:if test="${member.auths[0].auth == 'ROLE_MEMBER'}">
                                                        <input type="text" name="auth" value="Member" readonly>
                                                    	</c:if>
                                                    	<c:if test="${member.auths[0].auth == 'ROLE_MANAGER'}">
                                                        <input type="text" name="auth" value="Manager" readonly>
                                                    	</c:if>
                                                    	<c:if test="${member.auths[0].auth == 'ROLE_ADMIN'}">
                                                        <input type="text" name="auth" value="Admin" readonly>
                                                    	</c:if>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <li>
                                <h6 class="title collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFour"
                                    aria-expanded="false" aria-controls="collapseFour">Bookmark</h6>
                                    ...
                                    <div class="row">                                        
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                <label>Zipcode</label>
                                                <div class="form-input form">
                                                    <input type="text" name="zipcode" id="bm-zipcode" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                <label>Road Address</label>
                                                <div class="form-input form">
                                                    <input type="text" name="roadAddress" id="bm-roadAddress" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                <label>Address</label>
                                                <div class="form-input form">
                                                    <input type="text" name="address" id="bm-address" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                <label>Detail Address</label>
                                                <div class="form-input form">
                                                    <input type="text" name="detailAddress" id="bm-detailAddress">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                <!-- <label>latitude</label> -->
                                                <div class="form-input form">
                                                    <input type="hidden" name="latitude" id="bm-latitude">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                <!-- <label>longitude</label> -->
                                                <div class="form-input form">
                                                    <input type="hidden" name="longitude" id="bm-longitude">
                                                </div>
                                            </div>
                                        </div>

                                        <button type="button" id="btnAddr2" class="mb-3 mt-2 btn btn-sm btn-secondary">주소검색</button>

                                        <div id="map2" style="width:500px;height:350px;margin: 10px auto; border:1px solid; display:none"></div> <!-- 지도틀 -->
                                    ...
                                    searchDetailAddrFromCoords(mouseEvent.latLng, function(result, status) {
                                        if (status === kakao.maps.services.Status.OK) {
                                            ...
                                            data.roadAddress = result[0].road_address;
                                                var coords = new kakao.maps.Coords(mouseEvent.latLng.La, mouseEvent.latLng.Ma);
                                                if(result[0].road_address) {
                                                    $("#bm-roadAddress").val(result[0].road_address.address_name);
                                                    $("#bm-zipcode").val(result[0].road_address.zone_no);
                                                ...
                                                $("#bm-address").val(result[0].address.address_name);
                                                    $("#bm-latitude").val(coords.Ma);	            		
                                                    $("#bm-longitude").val(coords.La);	
                                        }   
                                    });
                                });
